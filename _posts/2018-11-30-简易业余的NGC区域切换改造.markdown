...
date:   2018-11-30 10:50:20 -0600
description: 并不专业，超业余的，仅供参考。
img: posts/2018-11-30/cover.jpg
tags: [任天堂, NGC, 硬件改造]
author: 本本子
mathjax: yes
---
...
<center>
<img src='./assets/img/posts/2018-11-30/2.jpg'>
    <div style="color:orange; border-bottom: 1px solid #d9d9d9;
    display: inline-block;
    color: #999;
    font-size:14px;
    padding: 2px;">资料来源：https://assemblergames.com/threads/cleaning-and-region-modd</div>
</center>

到了NGC时代，任天堂采用了1.4GB的8cm特制光盘作为载体，由松下电器开发。而在游戏载体上，通过物理锁区的方案，也因此无法继续使用。

<center>
<img src='./assets/img/posts/2018-11-30/3.jpg'>
    <div style="color:orange; border-bottom: 1px solid #d9d9d9;
    display: inline-block;
    color: #999;
    font-size:14px;
    padding: 2px;">NGC和8cm游戏光盘</div>
</center>
...
<center>
<img src='./assets/img/posts/2018-11-30/8.jpg'>
    <div style="color:orange; border-bottom: 1px solid #d9d9d9;
    display: inline-block;
    color: #999;
    font-size:14px;
    padding: 2px;">资料来源：https://www.gc-forever.com/wiki/index.php?title=Region_Switch</div>
</center>
...
<center>
<img src='./assets/img/posts/2018-11-30/4.jpg'>
    <div style="color:orange; border-bottom: 1px solid #d9d9d9;
    display: inline-block;
    color: #999;
    font-size:14px;
    padding: 2px;">部分工具</div>
</center>
...
<center>
<img src='./assets/img/posts/2018-11-30/5.jpg'>
    <div style="color:orange; border-bottom: 1px solid #d9d9d9;
    display: inline-block;
    color: #999;
    font-size:14px;
    padding: 2px;">导线短接失败。大概是我技术太菜了。</div>
</center>
...
<center>
<img src='./assets/img/posts/2018-11-30/6.jpg'>
    <div style="color:orange; border-bottom: 1px solid #d9d9d9;
    display: inline-block;
    color: #999;
    font-size:14px;
    padding: 2px;">第一步，拆机</div>
</center>
...
<center>
<img src='./assets/img/posts/2018-11-30/1.jpg'>
    <div style="color:orange; border-bottom: 1px solid #d9d9d9;
    display: inline-block;
    color: #999;
    font-size:14px;
    padding: 2px;">需要改造的电阻位置</div>
</center>
...
<center>
<img src='./assets/img/posts/2018-11-30/7.jpg'>
    <div style="color:orange; border-bottom: 1px solid #d9d9d9;
    display: inline-block;
    color: #999;
    font-size:14px;
    padding: 2px;">电烙铁预热中</div>
</center>
...
<center>
<img src='./assets/img/posts/2018-11-30/9.jpg'>
    <div style="color:orange; border-bottom: 1px solid #d9d9d9;
    display: inline-block;
    color: #999;
    font-size:14px;
    padding: 2px;">手动模拟光驱舱门合上状态</div>
</center>
...
<center>
<img src='./assets/img/posts/2018-11-30/10.jpg'>
    <div style="color:orange; border-bottom: 1px solid #d9d9d9;
    display: inline-block;
    color: #999;
    font-size:14px;
    padding: 2px;">测试无误，日版改造美版，并运行美版《密特罗德：究极》</div>
</center>
...
<center>
<img src='./assets/img/posts/2018-11-30/11.jpg'>
    <div style="color:orange; border-bottom: 1px solid #d9d9d9;
    display: inline-block;
    color: #999;
    font-size:14px;
    padding: 2px;">4:3被拉伸16:9是采集卡软件解码问题</div>
</center>
